...
/**
 * This class provides an empty implementation of snuqasmListener,
 * which can be extended to create a listener which only needs to handle a subset
 * of the available methods.
 */
class  snuqasmBaseListener : public snuqasmListener {
public:
  ...
  virtual void enterDesignatedIdentifier(snuqasmParser::DesignatedIdentifierContext * /*ctx*/) override { }
  virtual void exitDesignatedIdentifier(snuqasmParser::DesignatedIdentifierContext * /*ctx*/) override { }
