...
class Interpreter:
    ...
    by the parser, and building a braket.snuqs.openqasm.circuit.Circuit to hand
    off to a simulator e.g. braket.snuqs.state_vector_simulator.StateVectorSimulator.
