...
# https://github.com/Infleqtion/client-superstaq/blob/main/supermarq-benchmarks/supermarq/stabilizers.py
...
def apply_H(measurement_circuit: MeasurementCircuit, i: int) -> None:
    ...
    measurement_circuit.get_circuit().h(i)
...
def apply_S(measurement_circuit: MeasurementCircuit, i: int) -> None:
    ...
    measurement_circuit.get_circuit().s(i)
...
def apply_CZ(measurement_circuit: MeasurementCircuit, i: int, j: int) -> None:
    ...
    measurement_circuit.get_circuit().cz(i, j)
...
def apply_CNOT(
    ...
    measurement_circuit.get_circuit().cnot(control_index, target_index)
...
def apply_SWAP(measurement_circuit: MeasurementCircuit, i: int, j: int) -> None:
    ...
    measurement_circuit.get_circuit().swap(i, j)
