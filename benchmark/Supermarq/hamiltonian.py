...
class HamiltonianSimulation:
    ...
    def __init__(self, num_qubits: int, time_step: int = 1, total_time: int = 1, backend: str = None) -> None:
    ...
    def run(self, shots: int):
        ...
        print(f"Hamiltonian Simulation test score: {score}")
        return score